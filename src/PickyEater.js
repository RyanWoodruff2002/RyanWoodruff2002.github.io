...
function PickyEater() {
    ...
    return (
        <div className="grid justify-items-center items-center">
            <br/>
            <h1 className="text-5xl text-white centered pt-5 pb-5 bg-[#1F7A8C] w-full">Picky Eater</h1>
            <br/>
            ...
            <br/>
            <a target="_blank" className="text-[#1F7A8C] text-xl no-underline hover:underline ..." href="https://github.com/joshuag95/restaurant" >GitHub Repo</a>
            <br/>
            <iframe
                width="1000"
                height="600"
            ...
            <br/>
            <a target="_blank" className="text-[#1F7A8C] text-xl no-underline hover:underline ..." href="https://www.youtube.com/watch?v=eiMCfVZ2CvY" >Video Demo</a>
            <br/>
            <br/>
        </div>
    )
