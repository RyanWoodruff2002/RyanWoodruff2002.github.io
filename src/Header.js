      ...
      <div className="mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden space-x-10 md:flex">
            <Link to="/" className="text-base font-medium text-[#043A45] hover:text-gray-900">
              Home
            </Link>
                    ...
                    <Popover.Panel className="absolute z-10 -ml-4 mt-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
                      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                          <Link to='/PokemonFetcher' className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                            <p className="text-base font-medium text-[#043A45]">Pokemon Fetcher</p>
                          </Link>
                          <Link to='/PickyEater' className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                            <p className="text-base font-medium text-[#043A45]">Picky Eater</p>
                          </Link>
                          <Link to='/TicketRuler' className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                            <p className="text-base font-medium text-[#043A45]">Ticket Ruler</p>
                          </Link>
                          <Link to='/Aircnc' className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                            <p className="text-base font-medium text-[#043A45]">Aircnc</p>
                          </Link>
                          <Link to='/GameBuddy' className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
