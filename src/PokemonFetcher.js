...
function PokemonFetcher() {
    ...
    return (
        <div className="grid justify-items-center items-center">
            <br/>
            <h1 className="text-5xl text-white centered pt-5 pb-5 bg-[#1F7A8C] w-full">Pokemon Fetcher</h1>
            <br/>
            ...
            <a target="_blank" className="text-[#1F7A8C] text-xl no-underline hover:underline ..."  href="https://github.com/AndreaRose92/pokemon-fetcher" >GitHub Repo</a>
            <br/>
            <a target="_blank" className="text-[#1F7A8C] text-xl no-underline hover:underline ..." href="https://andrearose92.github.io/pokemon-fetcher/" >GitHub Pages Deployment</a>
            <br/>
            <iframe
                width="1000"
                height="600"
            ...
            <br/>
            <a target="_blank" className="text-[#1F7A8C] text-xl no-underline hover:underline ..." href="https://www.youtube.com/watch?v=T9cMqLCsjqY" >Video Demo</a>
            <br/>
            <br/>
        </div>
    )
